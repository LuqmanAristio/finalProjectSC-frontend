        ...
        <div className='w-5/6 h-full flex items-center justify-between'>
            <div className="w-2/4 h-full mr-10 flex flex-col justify-center">
                ...
                <div className='flex flex-col w-4/5 mx-auto'>
                    <h1 className='text-5xl font-extrabold text-[#282828] leading-tight'>Lung Cancer Diagnosis <br /> Based on CT Scan Image</h1>
            ...
            <div className="w-2/4 h-full ml-10 flex items-center justify-center flex-col">
                ...
                >
                    ...
                    <h4 className='absolute bottom-32 text-lg text-[#727272]'>or drag and drop a file here</h4>
                </div>
